...
if __name__ == "__main__":
    ...
    month_menu.bind("<<ComboboxSelected>>", lambda event: update_calendar())
    ...
    year_menu.bind("<<ComboboxSelected>>", lambda event: update_calendar())
    ...
    day_entry.bind("<Return>", lambda event: get_day())
