...
if __name__ == "__main__":
    ...
    month_menu.bind("<<ComboboxSelected>>", lambda e: update_calendar())
    ...
    year_menu.bind("<<ComboboxSelected>>", lambda e: update_calendar())
    ...
    day_entry.bind("<Return>", lambda e: get_day())
